  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Search Performance Metrics</h1>
          <p className="text-gray-500 mt-1">Comprehensive analytics for search functionality</p>
        </div>
        <button
          onClick={loadMetrics}
